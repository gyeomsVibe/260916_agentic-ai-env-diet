...
- 도구 상태(형식 고정, docs/20 A4 — 시각이 지나면 UNKNOWN으로 보고 첫 판정 전에 응답을 확인한다): `codex: ABSENT(QUOTA) until 2026-09-24T13:41+09:00, observed_by=claude_code, observed_at=2026-09-22` / `antigravity: ACTIVE (monitoring & proxy support scheduled, 15m cron), observed_by=antigravity, observed_at=2026-09-23T21:30:00+09:00`
