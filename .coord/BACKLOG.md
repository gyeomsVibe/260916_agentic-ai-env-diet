...
| B77 | RESOLVED (사용자 승인 2026-09-25; 이 저장소 적용, 전역 설치는 사용자 PC 실행 대기) | 활성화 3건: (1) Claude 유료 예약 도구 deny (2) 출석부 자동 훅 (3) 24/7 교환원. 이 저장소 `.claude/settings.json`에 (1)(2) 적용, 모든 프로젝트는 `python uaos_everywhere/install_uaos_everywhere.py --apply`, (3)은 `--register-sentinel <프로젝트>`(docs/39). Codex·Antigravity의 예약 기능 차단 설정은 UNKNOWN(규칙 문단으로만 금지) | U31·U35, docs/36 §6, docs/39 §4 | 사용자 PC 설치 시 |
